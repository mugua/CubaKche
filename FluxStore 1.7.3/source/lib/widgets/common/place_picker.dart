...
class PlacePickerState extends State<PlacePicker> {
  ...
  void decodeAndSelectPlace(String placeId) {
    ...
    String endpoint = "https://maps.googleapis.com/maps/api/place/details/json?key=${widget.apiKey}"
        "&placeid=$placeId";
...
class RichSuggestion extends StatelessWidget {
  ...
  List<TextSpan> getStyledTexts(BuildContext context) {
    ...
    final String startText = autoCompleteItem.text.substring(0, autoCompleteItem.offset);
    ...
    final String boldText = autoCompleteItem.text
    ...
    String remainingText =
        autoCompleteItem.text.substring(autoCompleteItem.offset + autoCompleteItem.length);
    result.add(
      TextSpan(
        text: remainingText,
        style: TextStyle(
