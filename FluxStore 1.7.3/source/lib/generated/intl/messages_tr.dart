...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(day) => "${day} Gün önce";

  static m1(message) => "Hata: ${message}";

  static m2(hour) => "${hour} Saat önce";

  static m3(minute) => "${minute} Dakika önce";

  static m4(itemCount) => "${itemCount} ürün";

  static m5(percent) => "% ${percent} İndirim ";

  static m6(second) => "${second} Saniye önce";

  static m7(totalCartQuantity) => "${totalCartQuantity} ürün, Sepette";

  static m8(message) => "Hata: ${message}";

  static m9(length) => " \$${length} Ürün Bulundu";
